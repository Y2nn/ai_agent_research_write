...
# Initialize the MDXSearchTool tool
config = {
    "embedder": {
        "provider": "cohere",
...
if __name__ == '__main__':
    ...
    job_application_inputs = {
        'job_posting_url': 'https://jobs.lever.co/AIFund/'
                           '6c82e23e-d954-4dd8-a734-c0c2c5ee00f1?lever-origin=applied&lever-source%5B%5D=AI+Fund',
